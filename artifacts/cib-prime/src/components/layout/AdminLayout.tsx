...
const navItems = [
  { href: '/admin', label: ' العملاء', icon: Users, exact: true },
  { href: '/admin/visitors', label: 'الزوار', icon: MonitorSmartphone },
  { href: '/admin/content', label: 'إعدادات الساعات', icon: Settings },
